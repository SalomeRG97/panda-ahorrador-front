  ...
  template: `
    <div class="years-container animate-fade-in-up">
      ...
      <div class="years-grid" *ngIf="years.length > 0; else emptyState">
        <div *ngFor="let y of years" class="year-card card-pastel">
...
export class YearListComponent implements OnInit {
  ...
  saveYear(): void {
    ...
    this.apiService.createYear(this.newYear, this.newStartMonth).subscribe({
      ...
      error: (err: any) => {
        this.loading = false;
        this.errorMessage = err.error?.message || 'Error al crear el año';
      }
    });
  }

  deleteYear(id: number, yearNum: number): void {
    if (confirm(`¿Estás segura de eliminar el año ${yearNum}? Se borrarán todos los gastos e ingresos asociados.`)) {
